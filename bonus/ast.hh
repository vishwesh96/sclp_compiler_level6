...
protected:
	...
	bool is_while;
public:
	Iteration_Statement_Ast(Ast* init,Ast * cond, Ast* update,Ast* body, int line, bool b1,bool b2,bool b3);
	// Iteration_Statement_Ast(Ast * cond,Ast* body, int line, loop_type ltype);
